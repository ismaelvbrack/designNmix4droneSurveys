...
We specifically addressed three aspects:
  ...
  3. **can the double-observer protocol be used to reduce field survey effort?**
...
- [see the simulation results on the performance and optimal survey design for (many) predefined scenarios](simul_results.html)
