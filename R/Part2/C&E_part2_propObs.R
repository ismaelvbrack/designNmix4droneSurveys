...
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
##*   Extract and clean simulation results part 2
##*      6 scenarios increasing proportion of 2obs
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

#* read raw results data
raw.resu <- readRDS(here::here("data","raw_simul_resu","resuPart2_propObs.rds"))

# scens 1-64 full 1obs and 2obs
resu0.1 <- readRDS(here::here("data","processed_simul_resu","resultsP1_scen1-64.rds"))
resu0.1 <- resu0.1[which(names(resu0.1) %in% names(raw.resu))]
...
# calculate error and join with results for 0% and 100%
for(i in 1:length(results)){
  ...
  results[[i]] <- rbind(results[[i]],resu0.1[[i]])
}

saveRDS(results, here::here("data","processed_simul_resu","resultsP2_propObs.rds"))
