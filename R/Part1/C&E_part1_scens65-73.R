...
##*  9 scenarios for high local abundances
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

#* read raw results data
raw.resu <- readRDS(here::here("data","raw_simul_resu","resuPart1_scens65-74.rds"))
...
saveRDS(results, here::here("data","processed_simul_resu","resultsP1_scen65-74.rds"))
